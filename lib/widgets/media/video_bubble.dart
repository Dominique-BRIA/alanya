...
class _VideoBubbleState extends State<VideoBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    final thumbUrl = hasThumbUrl && widget.token != null
        ...
        : widget.thumbnailUrl;
    final hasCaption = widget.caption != null && widget.caption!.trim().isNotEmpty;
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: SizedBox(
                width: widget.width,
                height: (hasCaption ? 200.0 : widget.maxHeight).clamp(180, 280),
                child: Stack(
                  fit: StackFit.expand,
                  children: [
                    ...
                    // Timestamp + coches en bas à droite (si pas de légende)
                    if (!hasCaption && widget.timestamp != null)
                      Positioned(
                        right: 6, bottom: 6,
                        child: Container(
                          padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 3),
            ...
            // Légende texte en bas sous la vidéo
            if (hasCaption)
              Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 11,
                                  color: widget.isMe ? Colors.white70 : AlanyaColors.grey600,
                                ),
                              ),
                              if (widget.statusWidget != null) ...[
                                const SizedBox(width: 3),
