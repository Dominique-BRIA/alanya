              ...
              Align(
                ...
                child: PinCodeTextField(
                  ...
                  pinTheme: PinTheme(
                    ...
                    inactiveColor: themed(context, light: AlanyaColors.sand, dark: AlanyaColors.ligne),
                    activeFillColor: themed(context, light: Colors.white, dark: surfacesOf(context).surface),
                    selectedFillColor: themed(context, light: Colors.white, dark: surfacesOf(context).surface),
                    inactiveFillColor: themed(context, light: Colors.white, dark: surfacesOf(context).surface),
                  ),
